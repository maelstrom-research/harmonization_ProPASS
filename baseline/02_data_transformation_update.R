...
#@NOTE: "02_data_transformation_update" should be run with Rmonize > 1.1.0
#@ the version of avant_apres_harmo() is NOT compatible with 1.1.0 or earlier.
#@ We are currently using it with Rmonize 1.1.0.9402 (2025-05-12)
...
if(!any(checks$harmonization_errors)){
  ...
  # before after report
  before_after_report <- 
    avant_apres_harmo(dossier = dossier,
