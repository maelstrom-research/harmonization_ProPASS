...
folder_name <- paste0("harmonization_linkage_", harmo_group)
...
download.file(
  url = "https://github.com/maelstrom-research/harmonization_ProPASS/raw/master/linkage/01_validation_inputs_linkage.R",
  destfile = paste0(folder_name, "/01_validation_inputs.R"),
  mode = "wb")

download.file(
  url = "https://github.com/maelstrom-research/harmonization_ProPASS/raw/master/linkage/02_data_transformation_linkage.R",
  destfile = paste0(folder_name, "/02_data_transformation.R"),
  mode = "wb")

download.file(
  url = "https://github.com/maelstrom-research/harmonization_ProPASS/raw/master/linkage/A-avant_apres_harmo.R",
