...
intro <- function(){
  ...
  message(
    ...
    It script will prepare your environment:
  ...
  choice_list <-
    c("AGN - Active aging - The AGNES study",
      ...
      "CLSA Comprehensive - Canadian Longitudinal Study on Aging Comprehensive",
      "CLSA Tracking - Canadian Longitudinal Study on Aging Tracking",
      "MacM3 - McMaster Monitoring My Mobility",
      "NHANES11 - National Health and Nutrition Examination Survey 2011",
      "NHANES13 - National Health and Nutrition Examination Survey 2013",
      ...
      "Tsuru Longitudinal- Tsuru Longitudinal Study",
      "Tsuru Checkup- Tsuru Health Checkup",
      "Wll - Whitehall study",
      "LISS - LISS panel")
...
download.file(
  url = "https://github.com/maelstrom-research/harmonization_ProPASS/raw/master/mortality/01_validation_inputs_mortality.R",
  destfile = paste0(folder_name, "/01_validation_inputs.R"),
  mode = "wb")

download.file(
  url = "https://github.com/maelstrom-research/harmonization_ProPASS/raw/master/mortality/02_data_transformation_mortality.R",
  destfile = paste0(folder_name, "/02_data_transformation.R"),
  mode = "wb")

download.file(
  url = "https://github.com/maelstrom-research/harmonization_ProPASS/raw/master/mortality/A-avant_apres_harmo.R",
